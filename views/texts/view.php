...
<h2 itemprop="name">21 Savage lyrics : <?= $texts->name ?></h2>
    ...
    <div class="texts_view_info">
        ...
        <?php if(!empty($texts->album)): ?>
            <h5><b>Album:</b> <?= $texts->album ?></h5>
        <?php endif; ?>
        <h6><i class="glyphicon glyphicon-eye-open"></i> Views: <?= $texts  ->view ?></h6>
        ...
        <hr/>
        <h3 class="title_popul">Other lyrics</h3>
        <ul class="popul_list">
